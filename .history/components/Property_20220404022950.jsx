...
const Property = ({
	...
	<Box p="3" paddingTop="0px" justifyContent="flex-start">
		<Flex flexWrap="wrap" w="402px" justifyContent="flex-start" border="1px" borderColor="gray.200" borderRadius="10px">
			<Link href={`/property/${externalID}`} passHref>
			...
			<Box w="full" p="3" paddingTop="0px">
				...
				<Flex flexWrap="wrap" alignItems="center" p="1" justifyContent="space-between">
					<Flex flexWrap="wrap">
						<Link href={`tel:${phoneNumber?.phone || phoneNumber?.mobile}`} passHref cursor="pointer">
							<Flex
								marginRight="3"
								alignItems="center"
						...
						<Link href={`https://wa.me/${phoneNumber?.whatsapp}`} passHref cursor="pointer">
							<Flex
								alignItems="center"
								justifyContent="center"
								color="green.400"
