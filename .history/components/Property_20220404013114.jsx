		...
		<Flex flexWrap="wrap" w="420px" p="5" paddingTop="0px" justifyContent="flex-start" cursor="pointer">
			...
			<Box w="full">
				...
				<Flex flexWrap="wrap" alignItems="center" p="1" justifyContent="space-between">
					<Flex flexWrap="wrap">
						<Flex marginRight="3" alignItems="center" justifyContent="center" color="green.400" onClick={() => {}}>
							<BsFillTelephoneOutboundFill />
							<Text marginLeft="2" fontSize="lg">
								Call
							</Text>
						</Flex>
						<Flex alignItems="center" justifyContent="center" color="green.400" onClick={() => {}}>
							<BsWhatsapp />
							<Text marginLeft="2" fontSize="lg">
								WhatsApp
							</Text>
					...
					<Flex alignItems="center" justifyContent="center" borderRadius="5px" p="21 bg="green.400">
						<BsFillPersonFill />
