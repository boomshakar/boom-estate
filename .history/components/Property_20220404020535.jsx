...
const Property = ({
	...
	<Box p="5" paddingTop="0px" justifyContent="flex-start">
		<Flex flexWrap="wrap" w="385px" justifyContent="flex-start">
			<Link href={`/property/${externalID}`} passHref>
				<Box cursor="pointer">
					<Image src={coverPhoto ? coverPhoto.url : DefaultImage} alt="house" width={360} height={260} />
				</Box>
			</Link>
			<Box w="full" border="1px" borderTop="0px" borderColor="gray.200" borderBottomRadius="10px">
